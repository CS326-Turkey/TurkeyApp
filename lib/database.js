...
exports.Charity = mongoose.model ('Charity',{
    name: String,
    uri: String,
    routing: String
});
...
exports.Credit = mongoose.model('Credit', {
    user_id: String,
    name: String,
...
exports.getCollection = function (conditions, Model) {
...
exports.getObjectByID = function (id, Model) {
...
/* Fetch a specific member from the collections. Require id. */
exports.getObject = function (conditions, Model) {
...
exports.addUser = function(first, last, pass, email, question, answer, admin) {
    var user = new User({
