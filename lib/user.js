...
exports.updateAvailable = (userid, amt) => {
	console.log('Amount being updated : ' + amt);
	console.log('The username in user is ' + userid);
	database.updateAvailable(userid, amt);
	return;
}

//=================================================================

exports.updateDonated = (userid, amt) => {
	console.log('Amount being updated : ' + amt);
	console.log('The username in user is ' + userid);
	database.updateDonated(userid, amt);
	return;
}
