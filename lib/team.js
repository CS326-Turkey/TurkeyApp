...
//  team.js
//
//  Give access to members of the team at Glean.
//
*/
...
var team = [
	member('zhuotao25', 'Zhuotao', 'Huang', 'junior', fs.readFileSync('./public/src/profile_zhuotao.txt')),
	member('chetinglin', 'Che-Ting', 'Lin', 'junior', fs.readFileSync('./public/src/profile_cheting.txt')),
	member('egendreau', 'Eric', 'Gendreau', 'junior', fs.readFileSync('./public/src/profile_eric.txt')),
	member('JingLiu122', 'Jing', 'Liu', 'senior', fs.readFileSync('./public/src/profile_jing.txt')),
	member('ralren', 'Ren', 'Delos Reyes', 'senior', fs.readFileSync('./public/src/profile_ren.txt')),
	member('xliu3', 'Xin', 'Liu', 'senior', fs.readFileSync('./public/src/profile_xin.txt'))
];
